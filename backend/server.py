...
EXPERIENCES = [
    ...
    {"id":"coffee","title":"Filter coffee at our family table","category":"Food","region":"Manipal","custodian":"Anitha Pai","role":"Home cook & coffee host","image":"https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?q=85&w=1000&auto=format&fit=crop","tone":"moss","price":"Fixed price","price_note":"₹1,200 per person","cap":"Small group: 2–4","policy":"Please ask before photographing our home","participation":"Hands-on","season":"Available year-round","verified":"Coastal Foodways Collective","boosted":True,"description":"Our kitchen is not a restaurant. It is where my mother taught me to roast the coffee and where cousins still argue over the right amount of jaggery. You will eat what we are eating that day.","review":"The coffee lesson was really a conversation with a family. I still make it on Sunday mornings.","reviewer":"Arjun, Mumbai","bio":"Anitha hosts from her family home, sharing a meal and the small rituals around it.","legacy":["Ask about the brass filter — it has a story."]},
    {"id":"ritual","title":"Before the town wakes","category":"Ritual / Religious","region":"Udupi","custodian":"Suresh Acharya","role":"Ritual custodian","image":"https://images.unsplash.com/photo-1548013146-72479768bada?q=85&w=1000&auto=format&fit=crop","tone":"ochre","price":"Donation-based","price_note":"Suggested ₹250","cap":"Capped access: 8","policy":"Audio recording only; no flash","participation":"Watch-only","season":"Early mornings, by request","verified":"Udupi Heritage Circle","boosted":False,"description":"The quiet before the first bell is what I want you to notice. This is a viewing, not a performance. I will show you where to stand and when to lower your voice.","review":"A gentle, respectful introduction to a place I thought I already knew.","reviewer":"Leela, Chennai","bio":"Suresh helps visitors understand the rhythm and boundaries of a fictionalized Krishna Matha-style ritual space.","legacy":["Leave room for the silence." ]},
